...
class FootsBodyScanScreen extends StatefulWidget {
  @override
  _FootsBodyScanScreenState createState() => _FootsBodyScanScreenState();
}

class _FootsBodyScanScreenState extends State<FootsBodyScanScreen> {
