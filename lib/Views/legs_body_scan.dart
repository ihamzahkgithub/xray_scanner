...
class LegsBodyScanScreen extends StatefulWidget {
  @override
  _LegsBodyScanScreenState createState() => _LegsBodyScanScreenState();
}

class _LegsBodyScanScreenState extends State<LegsBodyScanScreen> {
