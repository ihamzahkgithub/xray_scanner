...
class ChestBodyScanScreen extends StatefulWidget {
  @override
  _ChestBodyScanScreenState createState() => _ChestBodyScanScreenState();
}

class _ChestBodyScanScreenState extends State<ChestBodyScanScreen> {
