...
class MuscularCardNine extends StatelessWidget {
  @override
          ...
          Container(
            ...
            child: const SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'The muscles of the hips and legs are responsible for a wide range of movements, including walking, running, sitting, and standing. They are essential for both mobility and stability. Lets take a look at the major muscles in the hips and legs:',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 18.0,
                    ),
